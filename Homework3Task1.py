...
найденному ранее.
Подсказка № 4
Для вывода старого списка видеокарт, используйт ецикл,чтобы пройти по всем
элементам списка и распечатать их втребуемом формате. Для вывода нового списка
