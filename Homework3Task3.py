...
Подсказка №1
Используйте алгоритм сортировки пузырьком (BubbleSort). В этом алгоритме два
...
элемента на каждом шаге, так как он уже буде на своем месте. Внутренний цикл
сравнивает и меняет местами соседние элементы списка.
Подсказка №3
Во внутреннем цикле сравнивайте текущий элемент со следующим. Еслитекущий
элемент больше следующего, меняйте их местами. Этоприведет к тому, что на каждом
