...
# Длина списка: 9
# Подсказка № 1
# Для начала определите, какие буквы являются гласными. Это можно сделать, создав
# строку с гласными буквами русского алфавита: 'ауоыиэяюёе'.
# Подсказка № 2
# Создайте список vowels, который будет содержать только гласные буквы из
# введённого текста. Для этого используйте генератор списка (list comprehension),
# проверяя, входит ли каждая буква текста в строку с гласными.
# Подсказка № 3
# Для проверки на принадлежность буквы к гласным используйте оператор in.
# Например, i in 'ауоыиэяюёе' вернёт True, если i — гласная буква, и False в
# противном случае.
...
print('Список гласны букв:',vowels)
