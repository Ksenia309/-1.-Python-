...
'html':{
'head':{
'title': 'Куплю/продамтелефоннедорого'
},
'body':{
'h2': 'УнассамаянизкаяценанаiPhone',
'div': 'Купить',
'p': ‘Продать'
}
}
...
исходного сайта
    ...
    new_h2 = 'У нас самая низкая цена на{}'.format(name) # Изменяемзаголовоквторогоуровня
...
for _ in range(sites_count):
    product_name = input('Введите азвание продукта для нового сайта:')
