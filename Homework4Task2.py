...
# Считываем урожайность каждого куста
a = list(map(int, input().split()))

max_berries = 0

# Проходим по всем кустам грядки
for i in range(n):
    # Текущий куст, следующий и предыдущий.
    # Используем остаток от деления (%), чтобы правильно обработать края массива.
